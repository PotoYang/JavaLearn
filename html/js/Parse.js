...
(function () {
    ...
    Parser = (function () {
        ...
        Parser.prototype.parseList = function (lines, value, start) {
            var found, html, j, key, l, lastType, leftLines, leftStart, len, len1, line, matches, minSpace, row, rows,
                secondFound, secondMinSpace, space, text, type;
            html = '';
            minSpace = 99999;
        ...
        Parser.prototype.parseTable = function (lines, value, start) {
            var aligns, body, column, columns, head, html, ignores, j, key, l, last, len, len1, line, num, output, row,
                rows, tag, text;
